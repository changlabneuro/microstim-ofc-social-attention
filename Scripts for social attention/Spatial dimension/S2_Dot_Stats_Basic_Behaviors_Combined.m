...
Dot_variables=fieldnames(Dot_Day.data_01022020.current_sham);

%% Get Stats

for ngaze=1:length(Dot_variables)

    gaze_variables=char(Dot_variables(ngaze));
    ...
    for nmonkey=1:3
        ...
        for nOFC=1:length(OFC_day.(monkey_id))
            ...
            Sham_Sham.OFC.(gaze_variables).(monkey_id).mean=[Sham_Sham.OFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).sham_sham.(gaze_variables),'omitnan')];
            Sham_Stim.OFC.(gaze_variables).(monkey_id).mean=[Sham_Stim.OFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).sham_stim.(gaze_variables),'omitnan')];
            Stim_Sham.OFC.(gaze_variables).(monkey_id).mean=[Stim_Sham.OFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).stim_sham.(gaze_variables),'omitnan')];
            Stim_Stim.OFC.(gaze_variables).(monkey_id).mean=[Stim_Stim.OFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).stim_stim.(gaze_variables),'omitnan')];
    
            Current_Sham.OFC.(gaze_variables).(monkey_id).mean=[Current_Sham.OFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).current_sham.(gaze_variables),'omitnan')];
            Current_Stim.OFC.(gaze_variables).(monkey_id).mean=[Current_Stim.OFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).current_stim.(gaze_variables),'omitnan')];
             
            Sham_Sham.OFC.(gaze_variables).(monkey_id).median=[Sham_Sham.OFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).sham_sham.(gaze_variables),'omitnan')];
            Sham_Stim.OFC.(gaze_variables).(monkey_id).median=[Sham_Stim.OFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).sham_stim.(gaze_variables),'omitnan')];
            Stim_Sham.OFC.(gaze_variables).(monkey_id).median=[Stim_Sham.OFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).stim_sham.(gaze_variables),'omitnan')];
            Stim_Stim.OFC.(gaze_variables).(monkey_id).median=[Stim_Stim.OFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).stim_stim.(gaze_variables),'omitnan')];
    
            Current_Sham.OFC.(gaze_variables).(monkey_id).median=[Current_Sham.OFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).current_sham.(gaze_variables),'omitnan')];
            Current_Stim.OFC.(gaze_variables).(monkey_id).median=[Current_Stim.OFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).current_stim.(gaze_variables),'omitnan')];
        ...
        for nACCg=1:length(ACCg_day.(monkey_id))
            ...
            Sham_Sham.ACCg.(gaze_variables).(monkey_id).mean=[Sham_Sham.ACCg.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).sham_sham.(gaze_variables),'omitnan')];
            Sham_Stim.ACCg.(gaze_variables).(monkey_id).mean=[Sham_Stim.ACCg.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).sham_stim.(gaze_variables),'omitnan')];
            Stim_Sham.ACCg.(gaze_variables).(monkey_id).mean=[Stim_Sham.ACCg.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).stim_sham.(gaze_variables),'omitnan')];
            Stim_Stim.ACCg.(gaze_variables).(monkey_id).mean=[Stim_Stim.ACCg.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).stim_stim.(gaze_variables),'omitnan')];
    
            Current_Sham.ACCg.(gaze_variables).(monkey_id).mean=[Current_Sham.ACCg.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).current_sham.(gaze_variables),'omitnan')];
            Current_Stim.ACCg.(gaze_variables).(monkey_id).mean=[Current_Stim.ACCg.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).current_stim.(gaze_variables),'omitnan')];
             
            Sham_Sham.ACCg.(gaze_variables).(monkey_id).median=[Sham_Sham.ACCg.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).sham_sham.(gaze_variables),'omitnan')];
            Sham_Stim.ACCg.(gaze_variables).(monkey_id).median=[Sham_Stim.ACCg.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).sham_stim.(gaze_variables),'omitnan')];
            Stim_Sham.ACCg.(gaze_variables).(monkey_id).median=[Stim_Sham.ACCg.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).stim_sham.(gaze_variables),'omitnan')];
            Stim_Stim.ACCg.(gaze_variables).(monkey_id).median=[Stim_Stim.ACCg.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).stim_stim.(gaze_variables),'omitnan')];
    
            Current_Sham.ACCg.(gaze_variables).(monkey_id).median=[Current_Sham.ACCg.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).current_sham.(gaze_variables),'omitnan')];
            Current_Stim.ACCg.(gaze_variables).(monkey_id).median=[Current_Stim.ACCg.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).current_stim.(gaze_variables),'omitnan')];
        ...
        for ndmPFC=1:length(dmPFC_day.(monkey_id))
            ...
            Sham_Sham.dmPFC.(gaze_variables).(monkey_id).mean=[Sham_Sham.dmPFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).sham_sham.(gaze_variables),'omitnan')];
            Sham_Stim.dmPFC.(gaze_variables).(monkey_id).mean=[Sham_Stim.dmPFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).sham_stim.(gaze_variables),'omitnan')];
            Stim_Sham.dmPFC.(gaze_variables).(monkey_id).mean=[Stim_Sham.dmPFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).stim_sham.(gaze_variables),'omitnan')];
            Stim_Stim.dmPFC.(gaze_variables).(monkey_id).mean=[Stim_Stim.dmPFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).stim_stim.(gaze_variables),'omitnan')];
    
            Current_Sham.dmPFC.(gaze_variables).(monkey_id).mean=[Current_Sham.dmPFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).current_sham.(gaze_variables),'omitnan')];
            Current_Stim.dmPFC.(gaze_variables).(monkey_id).mean=[Current_Stim.dmPFC.(gaze_variables).(monkey_id).mean mean(Dot_Day.(field_id).current_stim.(gaze_variables),'omitnan')];
             
            Sham_Sham.dmPFC.(gaze_variables).(monkey_id).median=[Sham_Sham.dmPFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).sham_sham.(gaze_variables),'omitnan')];
            Sham_Stim.dmPFC.(gaze_variables).(monkey_id).median=[Sham_Stim.dmPFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).sham_stim.(gaze_variables),'omitnan')];
            Stim_Sham.dmPFC.(gaze_variables).(monkey_id).median=[Stim_Sham.dmPFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).stim_sham.(gaze_variables),'omitnan')];
            Stim_Stim.dmPFC.(gaze_variables).(monkey_id).median=[Stim_Stim.dmPFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).stim_stim.(gaze_variables),'omitnan')];
    
            Current_Sham.dmPFC.(gaze_variables).(monkey_id).median=[Current_Sham.dmPFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).current_sham.(gaze_variables),'omitnan')];
            Current_Stim.dmPFC.(gaze_variables).(monkey_id).median=[Current_Stim.dmPFC.(gaze_variables).(monkey_id).median median(Dot_Day.(field_id).current_stim.(gaze_variables),'omitnan')];
...
%% Save stats and create "Dot" variable for plotting
...
Dot.Sham_Sham=Sham_Sham;
Dot.Sham_Stim=Sham_Stim;
Dot.Stim_Sham=Stim_Sham;
Dot.Stim_Stim=Stim_Stim;
Dot.Current_Sham=Current_Sham;
Dot.Current_Stim=Current_Stim;
...
save('Dot_Basic_Behavior_Combined.mat','Dot','-v7.3')
...
[p_OFC, h_OFC] = signrank(Dot.Current_Stim.OFC.m1_distance_to_eyes_ipsi.All.mean-Dot.Current_Sham.OFC.m1_distance_to_eyes_ipsi.All.mean, Dot.Current_Stim.OFC.m1_distance_to_eyes_contra.All.mean-Dot.Current_Sham.OFC.m1_distance_to_eyes_contra.All.mean);
[p_dmPFC, h_dmPFC] = signrank(Dot.Current_Stim.dmPFC.m1_distance_to_eyes_ipsi.All.mean-Dot.Current_Sham.dmPFC.m1_distance_to_eyes_ipsi.All.mean, Dot.Current_Stim.dmPFC.m1_distance_to_eyes_contra.All.mean-Dot.Current_Sham.dmPFC.m1_distance_to_eyes_contra.All.mean);
[p_ACCg, h_ACCg] = signrank(Dot.Current_Stim.ACCg.m1_distance_to_eyes_ipsi.All.mean-Dot.Current_Sham.ACCg.m1_distance_to_eyes_ipsi.All.mean, Dot.Current_Stim.ACCg.m1_distance_to_eyes_contra.All.mean-Dot.Current_Sham.ACCg.m1_distance_to_eyes_contra.All.mean);

[p_OFC_Lynch, h_OFC_Lynch] = signrank(Dot.Current_Stim.OFC.m1_distance_to_eyes_ipsi.Lynch.mean-Dot.Current_Sham.OFC.m1_distance_to_eyes_ipsi.Lynch.mean, Dot.Current_Stim.OFC.m1_distance_to_eyes_contra.Lynch.mean-Dot.Current_Sham.OFC.m1_distance_to_eyes_contra.Lynch.mean);
[p_dmPFC_Lynch, h_dmPFC_Lynch] = signrank(Dot.Current_Stim.dmPFC.m1_distance_to_eyes_ipsi.Lynch.mean-Dot.Current_Sham.dmPFC.m1_distance_to_eyes_ipsi.Lynch.mean, Dot.Current_Stim.dmPFC.m1_distance_to_eyes_contra.Lynch.mean-Dot.Current_Sham.dmPFC.m1_distance_to_eyes_contra.Lynch.mean);
[p_ACCg_Lynch, h_ACCg_Lynch] = signrank(Dot.Current_Stim.ACCg.m1_distance_to_eyes_ipsi.Lynch.mean-Dot.Current_Sham.ACCg.m1_distance_to_eyes_ipsi.Lynch.mean, Dot.Current_Stim.ACCg.m1_distance_to_eyes_contra.Lynch.mean-Dot.Current_Sham.ACCg.m1_distance_to_eyes_contra.Lynch.mean);

[p_OFC_Tarantino, h_OFC_Tarantino] = signrank(Dot.Current_Stim.OFC.m1_distance_to_eyes_ipsi.Tarantino.mean-Dot.Current_Sham.OFC.m1_distance_to_eyes_ipsi.Tarantino.mean, Dot.Current_Stim.OFC.m1_distance_to_eyes_contra.Tarantino.mean-Dot.Current_Sham.OFC.m1_distance_to_eyes_contra.Tarantino.mean);
[p_dmPFC_Tarantino, h_dmPFC_Tarantino] = signrank(Dot.Current_Stim.dmPFC.m1_distance_to_eyes_ipsi.Tarantino.mean-Dot.Current_Sham.dmPFC.m1_distance_to_eyes_ipsi.Tarantino.mean, Dot.Current_Stim.dmPFC.m1_distance_to_eyes_contra.Tarantino.mean-Dot.Current_Sham.dmPFC.m1_distance_to_eyes_contra.Tarantino.mean);
[p_ACCg_Tarantino, h_ACCg_Tarantino] = signrank(Dot.Current_Stim.ACCg.m1_distance_to_eyes_ipsi.Tarantino.mean-Dot.Current_Sham.ACCg.m1_distance_to_eyes_ipsi.Tarantino.mean, Dot.Current_Stim.ACCg.m1_distance_to_eyes_contra.Tarantino.mean-Dot.Current_Sham.ACCg.m1_distance_to_eyes_contra.Tarantino.mean);
