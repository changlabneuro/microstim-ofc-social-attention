...
filenames = { ...
    'Gaze_Heat_Map_Run_Combined.mat' ...
  , 'Gaze_Heat_Map_ROI_Combined.mat' ...
  , 'Final_Gaze_Heat_Map_Combined.mat' ...
};

for i = 1:numel(filenames)
  load( fullfile('~/Downloads', filenames{i}) );
end
...
for nmonkey=1:3
    ...
    draw_rect( ax1, screen_rect_deg );
    draw_rect( ax1, left_screen_deg );
    draw_rect( ax1, right_screen_deg );
